...
public class Constants {
	...
	public static final String ACTION_UPLOAD_CATALOG = "uploadCatalog";
	...
	public static final String PARAM_NAME_FILE = "catalogFile";
	...
	public static final String PARAM_FILE_TYPE_VALUE_XHTML = "XHTML";
	public static final String PARAM_FILE_TYPE = "fileType";
	public static final String ACTION_DOWNLOAD_CATALOG = "downloadCatalog";
	public static final String ACTION_SHOW_DOWNLOAD_CATALOG = "showDownloadCatalog";
	...
	public static final String PATH_TO_BMECAT_PK = "C:\\BmeCat_PK.xslt";
	public static final String PATH_TO_PK_XHTML = "C:\\PK_XHTML.xslt";
	...
	public static final String ELEMENT_CATALOG_ID = "CATALOG_ID";
	public static final String ELEMENT_CATALOG_VERSION = "CATALOG_VERSION";
	public static final String ELEMENT_CATALOG_NAME = "CATALOG_NAME";
	public static final String ELEMENT_SUPPLIER = "SUPPLIER";
	public static final String ELEMENT_TNEWCATALOG = "T_NEW_CATALOG";
